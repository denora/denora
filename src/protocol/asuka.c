...
/*                                                                       */
/* $Id: asuka.c 691 2006-09-04 16:48:13Z trystan $                      */
/*                                                                       */
/*************************************************************************/
        ...
        if (ac == 10) {
            ...
            user =
                do_nick(source, av[0], av[3], av[4], (s ? s->name : temp),
                        ...
                        av[8], strtoul(av[1], NULL, 10), av[5]);
            free(ipchar);
        } else if (ac == 9) {
...
int denora_event_squit(char *source, int ac, char **av)
{
    ...
    if (ac != 2) {
        alog(LOG_DEBUG,
             "Unknown SQUIT formatted message please report the following");
        protocol_debug(source, ac, av);
        return MOD_CONT;
    }
    do_squit(av[0]);
...
int DenoraInit(int argc, char **argv)
{
    ...
    moduleAddVersion("$Id: asuka.c 691 2006-09-04 16:48:13Z trystan $");
