...
-- 
-- Host: localhost
-- Generation Time: Jul 03, 2005 at 06:25 PM
-- Server version: 4.0.14
-- PHP Version: 5.0.3
-- 
-- Database: `denora_hyperion`
-- 
...
CREATE TABLE `user` (
  ...
  `mode_u0` enum('Y','N') NOT NULL default 'N',
  `mode_u1` enum('Y','N') NOT NULL default 'N',
  `mode_u2` enum('Y','N') NOT NULL default 'N',
  `mode_u3` enum('Y','N') NOT NULL default 'N',
  `mode_u4` enum('Y','N') NOT NULL default 'N',
  `mode_u5` enum('Y','N') NOT NULL default 'N',
  `mode_u9` enum('Y','N') NOT NULL default 'N',
  PRIMARY KEY  (`nickid`),
