...
-- 
-- Host: localhost
-- Generation Time: Jan 16, 2005 at 05:33 PM
-- Server version: 4.0.20
-- PHP Version: 5.0.3
-- $Id: solidircd.sql 712 2006-09-16 11:24:27Z trystan $
-- 
-- Database: `denora-solid`
-- 
...
-- 
-- Table structure for table `chanexcept`
-- 
...
-- 
-- Table structure for table `chaninvites`
-- 
...
-- 
-- Table structure for table `maxvalues`
-- 
...
CREATE TABLE `user` (
  ...
  `mode_lb` enum('Y','N') NOT NULL default 'Y',
  `mode_lc` enum('Y','N') NOT NULL default 'N',
  `mode_ld` enum('Y','N') NOT NULL default 'N',
  `mode_le` enum('Y','N') NOT NULL default 'Y',
  `mode_lf` enum('Y','N') NOT NULL default 'Y',
  `mode_lg` enum('Y','N') NOT NULL default 'N',
  `mode_lh` enum('Y','N') NOT NULL default 'N',
  `mode_li` enum('Y','N') NOT NULL default 'N',
  `mode_lj` enum('Y','N') NOT NULL default 'Y',
  `mode_lk` enum('Y','N') NOT NULL default 'Y',
  `mode_lm` enum('Y','N') NOT NULL default 'Y',
  `mode_ln` enum('Y','N') NOT NULL default 'Y',
  `mode_lo` enum('Y','N') NOT NULL default 'N',
  `mode_lr` enum('Y','N') NOT NULL default 'N',
  `mode_ls` enum('Y','N') NOT NULL default 'Y',
  `mode_lv` enum('Y','N') NOT NULL default 'N',
  `mode_lw` enum('Y','N') NOT NULL default 'N',
  `mode_lx` enum('Y','N') NOT NULL default 'N',
  `mode_ly` enum('Y','N') NOT NULL default 'Y',
  `mode_lz` enum('Y','N') NOT NULL default 'N',
  `mode_ua` enum('Y','N') NOT NULL default 'N',
  `mode_uc` enum('Y','N') NOT NULL default 'N',
  `mode_ud` enum('Y','N') NOT NULL default 'N',
  `mode_uf` enum('Y','N') NOT NULL default 'Y',
  `mode_uh` enum('Y','N') NOT NULL default 'N',
  `mode_ui` enum('Y','N') NOT NULL default 'Y',
  `mode_uk` enum('Y','N') NOT NULL default 'Y',
  `mode_uo` enum('Y','N') NOT NULL default 'Y',
  `mode_ur` enum('Y','N') NOT NULL default 'N',
...
--
-- Table structure for table `ustats`
--
...
--
-- Table structure for table `cstats`
--
